...
public class ResourceWriter {
    ...
    public static void writeResources(Path resourceDir) throws IOException {
        ...
        final IResource resource = resourceManager.getResource(new ResourceLocation(Constants.MOD_ID, "bg.png"));
    ...
    private static String getResourceAsString(String resourceName) throws IOException {
        IResourceManager resourceManager = Minecraft.getInstance().getResourceManager();
        final IResource resource = resourceManager.getResource(new ResourceLocation(Constants.MOD_ID, resourceName));
        final InputStream inputStream = resource.getInputStream();
